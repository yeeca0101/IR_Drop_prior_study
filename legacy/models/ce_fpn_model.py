...
class Decoder(nn.Module):
    def __init__(self,device):
        ...
        if device =='cpu':
            ...
            self.addcoord = AddCoords(rank=2,w=256,h=256,with_r=False,skiptile=True,device=device)
            self.tile16 = AddCoords(rank=2,w=16,h=16,with_r=False,skiptile=False,device=device)
